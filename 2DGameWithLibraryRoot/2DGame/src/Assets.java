...
public class Assets {
    ...
    public static BufferedImage thiefFront, policeFront, playerRight, playerBack, wall, grass, powerUp, hole; // variables which will correspond to pictures
    ...
    public static void init(){ // load everything in our game
        ...
        SpriteSheet holesheet = new SpriteSheet(ImageLoader.loadImage("/textures1/hole.png"));
